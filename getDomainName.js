...
exports.findOwnedNameAccountsForUser = void 0;
var spl_name_service_1 = require("@bonfida/spl-name-service");
function findOwnedNameAccountsForUser(connection, userAccount) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, connection.getProgramAccounts(spl_name_service_1.NAME_PROGRAM_ID, {
                            filters: filters,
                        })];
                case 1:
                    accounts = _a.sent();
